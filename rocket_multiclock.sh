...
WAVE_OUT="$1"
ssh $USR@$SERVER 'cd /scratch/sondhi.tushar/firesim;source env.sh;cd sim/generated-src/f1/FireSimMulticlockPOC_FireSimQuadRocketMulticlockConfig-WithSynthAsserts_BaseF1Config;vpd2vcd waves.vpd waveform.vcd' w > $OUT
...
mv waveform.vcd ../waveform_receptacle/MulticlockRocketChip/$WAVE_OUT
